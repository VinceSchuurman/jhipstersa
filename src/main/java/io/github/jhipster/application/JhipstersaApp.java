...
public class JhipstersaApp {

    private static final Logger log = LoggerFactory.getLogger(JhipstersaApp.class);

    private final Environment env;

    public JhipstersaApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipstersa.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipstersaApp.class);
